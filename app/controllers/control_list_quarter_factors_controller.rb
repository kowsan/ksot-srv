class ControlListQuarterFactorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @control_list_quarter_factor.save
        format.html { redirect_to @control_list_quarter_factor, notice: 'Control list quarter factor was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @control_list_quarter_factor.update(control_list_quarter_factor_params)
        format.html { redirect_to @control_list_quarter_factor, notice: 'Control list quarter factor was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to control_list_quarter_factors_url, notice: 'Control list quarter factor was successfully destroyed.' }
  ...
  private
    ...
    def control_list_quarter_factor_params
      params.require(:control_list_quarter_factor).permit(:order_num, :factor, :is_active, :comment)
    end
end
