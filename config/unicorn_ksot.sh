...
#[[ -s "/home/util/.rvm/scripts/rvm" ]] && source "/home/util/.rvm/scripts/rvm" # Load RVM into a shell session *as a function*

TIMEOUT=${TIMEOUT-60}
APP_ROOT=/www/rails/ksot/current
PID=/www/rails/ksot/shared/pids/unicorn.pid
#CMD="su - util -c \"bundle exec unicorn_rails -D -c $APP_ROOT/config/unicorn.rb -E production\""
